...
if(isset($_POST['status']) == "success")
{
  ...
  $query = "UPDATE booking SET payment_status='paid' WHERE txn_id='$txnid' AND email='$user_email';";
  $result = mysqli_query($conn, $query);

  if($result)
  {
    $sql = "SELECT * FROM booking WHERE txn_id='$txnid' AND email='$user_email';";
    ...
    sendmail('manojavhale@gmail.com', $subject, $messageForDriver);
  }
  else
  {

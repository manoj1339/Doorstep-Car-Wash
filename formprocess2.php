...
if(isset($_GET['txn_id']))
{
  ...
  $surl = "https://www.carecarz.com/plansuccess.php";
  $furl = "https://www.carecarz.com/fail.php";

  $query = "SELECT * FROM bookpackage WHERE txn_id='$txnid' AND email='$user_email' LIMIT 1;";
  ...
  if($result_rows > 0)
  {
    ...
    {
      $amount = $row['plancharge'];
      $product_info = $row['plan'];
    }
  }
  else
  {
  ...
  $hash_string = $MERCHANT_KEY. "|".$txnid."|".$amount."|".$product_info."|".$firstname."|".$user_email."|".$user_email."|".$user_mobile."|".$lastname."|".$address."|".$brand."|".$vehicle_model."|".$vehicle_no."||||".$SALT;
...
<body onload="submitForm();">
  ...
  <form name="postForm" action="https://secure.payu.in/_payment/_payment" method="POST" >
